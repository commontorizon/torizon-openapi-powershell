...
BadRequestRepr<PSCustomObject>
#>

function Initialize-TorizonPlatformAPIBadRequestRepr {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIBadRequestRepr' | Write-Debug
...
Convert from JSON to BadRequestRepr<PSCustomObject>
...
BadRequestRepr<PSCustomObject>
#>
function ConvertFrom-TorizonPlatformAPIJsonToBadRequestRepr {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIBadRequestRepr' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TorizonPlatformAPIBadRequestRepr

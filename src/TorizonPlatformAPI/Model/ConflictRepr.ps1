...
ConflictRepr<PSCustomObject>
#>

function Initialize-TorizonPlatformAPIConflictRepr {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIConflictRepr' | Write-Debug
...
Convert from JSON to ConflictRepr<PSCustomObject>
...
ConflictRepr<PSCustomObject>
#>
function ConvertFrom-TorizonPlatformAPIJsonToConflictRepr {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIConflictRepr' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TorizonPlatformAPIConflictRepr

...
PaginationResultNetworkInfo<PSCustomObject>
#>

function Initialize-TorizonPlatformAPIPaginationResultNetworkInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultNetworkInfo' | Write-Debug
...
Convert from JSON to PaginationResultNetworkInfo<PSCustomObject>
...
PaginationResultNetworkInfo<PSCustomObject>
#>
function ConvertFrom-TorizonPlatformAPIJsonToPaginationResultNetworkInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultNetworkInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TorizonPlatformAPIPaginationResultNetworkInfo

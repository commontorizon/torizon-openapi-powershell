...
PaginationResultDeviceInfoBasic<PSCustomObject>
#>

function Initialize-TorizonPlatformAPIPaginationResultDeviceInfoBasic {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultDeviceInfoBasic' | Write-Debug
...
Convert from JSON to PaginationResultDeviceInfoBasic<PSCustomObject>
...
PaginationResultDeviceInfoBasic<PSCustomObject>
#>
function ConvertFrom-TorizonPlatformAPIJsonToPaginationResultDeviceInfoBasic {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultDeviceInfoBasic' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TorizonPlatformAPIPaginationResultDeviceInfoBasic

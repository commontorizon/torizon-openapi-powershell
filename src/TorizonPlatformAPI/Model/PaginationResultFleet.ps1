...
PaginationResultFleet<PSCustomObject>
#>

function Initialize-TorizonPlatformAPIPaginationResultFleet {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultFleet' | Write-Debug
...
Convert from JSON to PaginationResultFleet<PSCustomObject>
...
PaginationResultFleet<PSCustomObject>
#>
function ConvertFrom-TorizonPlatformAPIJsonToPaginationResultFleet {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultFleet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TorizonPlatformAPIPaginationResultFleet

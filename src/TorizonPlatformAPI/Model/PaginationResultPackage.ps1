...
PaginationResultPackage<PSCustomObject>
#>

function Initialize-TorizonPlatformAPIPaginationResultPackage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultPackage' | Write-Debug
...
Convert from JSON to PaginationResultPackage<PSCustomObject>
...
PaginationResultPackage<PSCustomObject>
#>
function ConvertFrom-TorizonPlatformAPIJsonToPaginationResultPackage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultPackage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TorizonPlatformAPIPaginationResultPackage

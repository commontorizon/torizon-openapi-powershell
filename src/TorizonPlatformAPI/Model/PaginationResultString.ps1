...
PaginationResultString<PSCustomObject>
#>

function Initialize-TorizonPlatformAPIPaginationResultString {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultString' | Write-Debug
...
Convert from JSON to PaginationResultString<PSCustomObject>
...
PaginationResultString<PSCustomObject>
#>
function ConvertFrom-TorizonPlatformAPIJsonToPaginationResultString {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultString' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TorizonPlatformAPIPaginationResultString

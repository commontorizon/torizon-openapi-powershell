...
UpstreamEndpointErrorRepr<PSCustomObject>
#>

function Initialize-TorizonPlatformAPIUpstreamEndpointErrorRepr {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIUpstreamEndpointErrorRepr' | Write-Debug
...
Convert from JSON to UpstreamEndpointErrorRepr<PSCustomObject>
...
UpstreamEndpointErrorRepr<PSCustomObject>
#>
function ConvertFrom-TorizonPlatformAPIJsonToUpstreamEndpointErrorRepr {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIUpstreamEndpointErrorRepr' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TorizonPlatformAPIUpstreamEndpointErrorRepr

...
function Initialize-TorizonPlatformAPIPackage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPackage' | Write-Debug
...
Package<PSCustomObject>
#>
function ConvertFrom-TorizonPlatformAPIJsonToPackage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPackage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TorizonPlatformAPIPackage
        $AllProperties = ("pkgType", "uri", "createdAt", "hardwareIds", "name", "version", "size", "comment", "hashes", "proprietaryMeta", "packageId")

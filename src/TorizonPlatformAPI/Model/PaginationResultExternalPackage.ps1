...
PaginationResultExternalPackage<PSCustomObject>
#>

function Initialize-TorizonPlatformAPIPaginationResultExternalPackage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultExternalPackage' | Write-Debug
...
Convert from JSON to PaginationResultExternalPackage<PSCustomObject>
...
PaginationResultExternalPackage<PSCustomObject>
#>
function ConvertFrom-TorizonPlatformAPIJsonToPaginationResultExternalPackage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPIPaginationResultExternalPackage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TorizonPlatformAPIPaginationResultExternalPackage

...
NotFoundRepr<PSCustomObject>
#>

function Initialize-TorizonPlatformAPINotFoundRepr {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPINotFoundRepr' | Write-Debug
...
Convert from JSON to NotFoundRepr<PSCustomObject>
...
NotFoundRepr<PSCustomObject>
#>
function ConvertFrom-TorizonPlatformAPIJsonToNotFoundRepr {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: TorizonPlatformAPI => TorizonPlatformAPINotFoundRepr' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TorizonPlatformAPINotFoundRepr

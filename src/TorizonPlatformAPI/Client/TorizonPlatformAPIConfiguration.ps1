...
Get the configuration object 'TorizonPlatformAPIConfiguration'.
...
#>
function Get-TorizonPlatformAPIConfiguration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://app.torizon.io/api/v2beta";
    }
...
System.Collections.Hashtable
#>
function Set-TorizonPlatformAPIConfiguration {
...
None
#>
function Set-TorizonPlatformAPIConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-TorizonPlatformAPIConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-TorizonPlatformAPIConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
System.Collections.Hashtable[]
#>
function Get-TorizonPlatformAPIHostSetting {
    return ,@(
          @{
...
String
#>
function Get-TorizonPlatformAPIUrlFromHostSetting {
    ...
    Process {
        $Hosts = Get-TorizonPlatformAPIHostSetting
...
System.Collections.Hashtable
#>
function Set-TorizonPlatformAPIConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-TorizonPlatformAPIKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'TorizonPlatformAPIConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-TorizonPlatformAPIConfigurationHttpSigning{
